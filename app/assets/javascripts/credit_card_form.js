...
function GetURLParameter(sParam) {
  ...
  var sURLVariables = sPageURL.split('&'); // not necessary in this case but useful in others
...
// handle event of plan dropdown changingar 
...
// function to call plan chane handler so that the plan is set correctly in dropdown on page load
